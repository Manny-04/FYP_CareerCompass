...
const variantClasses = {
  primary: 'bg-green-700 text-white hover:bg-green-800 disabled:bg-green-400',
  secondary: 'bg-white text-gray-800 border border-gray-200 hover:bg-gray-50 disabled:opacity-50',
